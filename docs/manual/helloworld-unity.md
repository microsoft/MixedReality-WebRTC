...
In this tutorial we will create a simple Unity application based on the [MixedReality-WebRTC Unity integration](xref:Microsoft.MixedReality.WebRTC.Unity).
