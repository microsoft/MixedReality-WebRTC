...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    /// Peer event frontend
    /// </summary>
    [RequireComponent(typeof(PeerConnection))]
    public class PeerEvents : MonoBehaviour //, IPeerImpl
    {
        /// <summary>
        /// A peer event composed of a single string literal.
        /// </summary>
        [Serializable]
        ...
        /// </summary>
        [Serializable]
        public class LocalSdpReadyToSendEvent : UnityEvent<string, string>
        {
        }
        ...
        /// </summary>
        [Serializable]
        public class IceCandidateReadyToSendEvent : UnityEvent<string, int, string>
        {
        }
        ...
        /// </summary>
        /// <remarks>
        /// This is the same as <see cref="Webrtc.OnInitialized"/> but is included here for convenience
        /// </remarks>
        ...
        public StringEvent OnDataFromDataChannelReady = new StringEvent();
        ...
        public IceCandidateReadyToSendEvent OnIceCandiateReadyToSend = new IceCandidateReadyToSendEvent();
        ...
        public LocalSdpReadyToSendEvent OnLocalSdpReadyToSend = new LocalSdpReadyToSendEvent();

        /// <summary>
        /// Event that occurs when an sdp offer is prepared
        /// </summary>
        [Tooltip("Event that occurs when an sdp offer is prepared")]
        public StringEvent OnSdpOfferReadyToSend = new StringEvent();

        /// <summary>
        /// Event that occurs when an sdp answer is prepared
        /// </summary>
        [Tooltip("Event that occurs when an sdp answer is prepared")]
        public StringEvent OnSdpAnswerReadyToSend = new StringEvent();

        /// <summary>
        /// The underlying native peer connection.
        /// </summary>
        ...
        public void OnInitialized()
        {
            ...
            //_nativePeer.DataFromDataChannelReady += Peer_DataFromDataChannelReady;
            //_nativePeer.FailureMessage += Peer_FailureMessage;
            _nativePeer.IceCandidateReadytoSend += Peer_IceCandidateReadytoSend;
            //_nativePeer.LocalDataChannelReady += Peer_LocalDataChannelReady;
            _nativePeer.LocalSdpReadytoSend += Peer_LocalSdpReadytoSend;

            // setup unity events for processing out additional pieces.
            OnLocalSdpReadyToSend.AddListener(new UnityAction<string, string>(OnLocalSdpReadyToSend_Listener));

            // if the caller demands auto-log behavior...
            if (AutoLogErrors)
            {
                // we bind a handler for that.
                OnFailure.AddListener(new UnityAction<string>(OnFailure_Listener));
            }
        ...
        private void Peer_DataFromDataChannelReady(string s)
        {
            ...
            {
                OnDataFromDataChannelReady.Invoke(s);
            });
        }
        ...
        private void Peer_IceCandidateReadytoSend(string candidate, int sdpMlineIndex, string sdpMid)
        {
            ...
            _mainThreadWorkQueue.Enqueue(() =>
            {
                OnIceCandiateReadyToSend.Invoke(candidate, sdpMlineIndex, sdpMid);
            });
        }
        ...
        private void Peer_LocalDataChannelReady()
        {
            ...
            _mainThreadWorkQueue.Enqueue(() =>
            {
                OnLocalDataChannelReady.Invoke();
            });
        }
        ...
        private void Peer_LocalSdpReadytoSend(string type, string sdp)
        {
            ...
            _mainThreadWorkQueue.Enqueue(() =>
            {
                OnLocalSdpReadyToSend.Invoke(type, sdp);
            });
        }
        ...
        public void AddDataChannel()
        {
            if (_nativePeer != null)
            {
                ...
                //_nativePeer.AddDataChannel();
            }
        }

        public void AddIceCandidate(string candidate, int sdpMlineindex, string sdpMid)
        {
            // Note: sdpMid and candidate are reversed here
            _nativePeer?.AddIceCandidate(sdpMid, sdpMlineindex, candidate);
        }
        ...
        public void ClosePeerConnection()
        {
            if (_nativePeer != null)
            {
                ...
                GetComponent<PeerConnection>().Uninitialize();
                _nativePeer = null;
            }
        }
        ...
        public int GetUniqueId()
        {
            ...
            {
                throw new NotImplementedException();
                //return _nativePeer.GetUniqueId();
            }
            else
            {
                return -1;
        ...
        public void SendDataViaDataChannel(string data)
        {
            ...
            {
                throw new NotImplementedException();
                //_nativePeer.SendDataViaDataChannel(data);
            }
        }
        ...
        public void SetAudioControl(bool isMute, bool isRecord)
        {
            ...
            {
                throw new NotImplementedException();
                //_nativePeer.SetAudioControl(isMute, isRecord);
            }
        }
        ...
        public void SetRemoteDescription(string type, string sdp)
        {
            if (_nativePeer != null)
            {
                _nativePeer.SetRemoteDescription(type, sdp);
            }
        }
        ...
        /// may easily wire UnityEvents to Log calls using <c>Log()</c> as a reference in editor
        /// </summary>
#region log helpers
